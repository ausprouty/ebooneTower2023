{
  mode: 'production',
  context: 'C:\\xampp73\\htdocs\\eboone',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    dgram: 'empty',
  ...
  output: {
    path: 'C:\\xampp73\\htdocs\\eboone\\dist',
        ...
        use: [
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'C:\\xampp73\\htdocs\\eboone\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '1dd6b001'
            }
          },
          {
            loader: 'vue-loader',
      ...
      /* config.module.rule('css') */
      {
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              {
                loader: 'C:\\xampp73\\htdocs\\eboone\\node_modules\\mini-css-extract-plugin\\dist\\loader.js',
                options: {
                  hmr: false,
                  publicPath: '../'
                }
        ...
        use: [
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '0cf0cfcd',
              emitWarning: true,
              emitError: false,
              eslintPath: 'C:\\xampp73\\htdocs\\eboone\\node_modules\\eslint',
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          NODE_ENV: '"production"',
          VUE_APP_DEFAULT_SITES_URL: '"http://10.1.1.9:9000/edit/public/api/"',
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\xampp73\\htdocs\\eboone\\public\\index.html'
      }
    ),
    /* config.plugin('pwa') */
    new HtmlPwaPlugin(
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'C:\\xampp73\\htdocs\\eboone\\public',
          to: 'C:\\xampp73\\htdocs\\eboone\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
