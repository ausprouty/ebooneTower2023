...
function verifyBookMedia($p)
{
    ...
    $dir_series_content = $p['dir_capacitor'] . 'folder/content/' . $p['dir_series'] . '/';
...
{
    $ok = true;
    $file = $p['dir_capacitor'] . 'folder/content/' . $p['dir_series'] . '/' . $file_name;
    $sd_media_location = $p['dir_capacitor'] . 'folder/media/' . SITE_CODE . '/';
