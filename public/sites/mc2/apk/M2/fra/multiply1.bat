...
ffmpeg  -accurate_seek -i vimeo/La Question Fascinante-286515674.mp4 -ss 0  -vf scale=480:-1    video/multiply1/108.mp4
ffmpeg  -accurate_seek -i lumo/LUMOLuke5139.mp4 -ss 370 -to 445   -vf scale=480:-1  video/multiply1/109.mp4
ffmpeg  -accurate_seek -i acts/PaulSpeakstotheCrowd.mp4 -ss 44 -to 299   -vf scale=480:-1  video/multiply1/110.mp4
ffmpeg  -accurate_seek -i acts/JesusTakenUpIntoHeaven.mp4 -ss 0 -to 103   -vf scale=480:-1  video/multiply1/111.mp4
ffmpeg  -accurate_seek -i acts/PeteratCornelius39sHouse.mp4 -ss 0 -to 234   -vf scale=480:-1  video/multiply1/112.mp4
...
ffmpeg  -accurate_seek -i acts/TheBelieversShareTheirPossessions.mp4 -ss 0  -vf scale=480:-1    concat/115.mp4
ffmpeg  -accurate_seek -i acts/AnaniasandSapphira.mp4 -ss 0  -vf scale=480:-1    concat/115-1.mp4
