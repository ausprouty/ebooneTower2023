...
ffmpeg -f concat -safe 0 -i concat/mutiply314.txt -c copy video/multiply3/314.mp4
...
ffmpeg -f concat -safe 0 -i concat/mutiply319.txt -c copy video/multiply3/319.mp4
...
ffmpeg -f concat -safe 0 -i concat/mutiply323.txt -c copy video/multiply3/323.mp4
