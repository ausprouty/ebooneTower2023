...
ffmpeg  -accurate_seek -i lumo/LUMOLuke840917.mp4 -ss 213 -to 260   -vf scale=480:-1  concat/234.mp4
ffmpeg  -accurate_seek -i lumo/LUMOMatthew10142.mp4 -ss 42 -to 191   -vf scale=480:-1  concat/234-1.mp4
...
ffmpeg  -accurate_seek -i lumo/LUMOMatthew27322820.mp4 -ss 146 -to 174   -vf scale=480:-1  concat/249-1.mp4
