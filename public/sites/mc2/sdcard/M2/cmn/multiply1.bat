...
ffmpeg  -accurate_seek -i acts/TheFellowshipoftheBelievers.mp4 -ss 0 -to 53   -vf scale=480:-1  concat/113.mp4
ffmpeg  -accurate_seek -i acts/TheSendingofBarnabasandSaul.mp4 -ss 11 -to 37   -vf scale=480:-1  concat/113-1.mp4
ffmpeg -f concat -safe 0 -i concat/multiply113.txt -c copy video/multiply1/113.mp4
