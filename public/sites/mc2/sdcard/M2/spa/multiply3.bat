...
mkdir multiply3
cd ..
ffmpeg  -accurate_seek -i youtube/biTh0SIiHWQ.mp4 -ss 0  -vf scale=480:-1    video/multiply3/3intro0.mp4
...
ffmpeg  -accurate_seek -i acts/PeterHealsaLameBeggar.mp4 -ss 0  -vf scale=480:-1    concat/306.mp4
...
ffmpeg  -accurate_seek -i acts/PeterandJohnbeforetheSanhedrin.mp4 -ss 0  -vf scale=480:-1    concat/307.mp4
...
ffmpeg  -accurate_seek -i acts/TheBelieversShareTheirPossessions.mp4 -ss 0  -vf scale=480:-1    concat/308.mp4
...
ffmpeg  -accurate_seek -i acts/TheApostlesHealMany.mp4 -ss 0  -vf scale=480:-1    concat/309.mp4
...
ffmpeg  -accurate_seek -i acts/StoningofStephen.mp4 -ss 0  -vf scale=480:-1    concat/313.mp4
...
ffmpeg  -accurate_seek -i acts/PhilipinSamaria.mp4 -ss 0  -vf scale=480:-1    concat/314.mp4
...
ffmpeg  -accurate_seek -i acts/CorneliusSeesanAngel.mp4 -ss 0  -vf scale=480:-1    concat/319.mp4
ffmpeg  -accurate_seek -i acts/Peter39sVision.mp4 -ss 0  -vf scale=480:-1    concat/319-1.mp4
ffmpeg  -accurate_seek -i acts/PeteratCornelius39sHouse.mp4 -ss 0  -vf scale=480:-1    concat/319-2.mp4
...
ffmpeg  -accurate_seek -i acts/Peter39sMiraculousEscapeFromPrison.mp4 -ss 0  -vf scale=480:-1    concat/323.mp4
...
ffmpeg  -accurate_seek -i acts/TheSendingofBarnabasandSaul.mp4 -ss 0  -vf scale=480:-1    concat/324.mp4
...
ffmpeg  -accurate_seek -i acts/PaulsMinistryInPisidianAntioch.mp4 -ss 0  -vf scale=480:-1    video/multiply3/325.mp4
...
ffmpeg  -accurate_seek -i acts/TheCouncilatJerusalem.mp4 -ss 0  -vf scale=480:-1    concat/330.mp4
...
ffmpeg  -accurate_seek -i acts/DisagreementBetweenPaulandBarnabas.mp4 -ss 0  -vf scale=480:-1    concat/331.mp4
...
ffmpeg  -accurate_seek -i acts/Paul39sVisionoftheManofMacedonia.mp4 -ss 0  -vf scale=480:-1    concat/332.mp4
...
ffmpeg  -accurate_seek -i acts/RiotsinThessalonica.mp4 -ss 0  -vf scale=480:-1    concat/334.mp4
...
ffmpeg  -accurate_seek -i acts/DivisioninCorinth.mp4 -ss 0  -vf scale=480:-1    concat/336.mp4
ffmpeg  -accurate_seek -i acts/PriscillaAquilaandApollos.mp4 -ss 0  -vf scale=480:-1    concat/336-1.mp4
...
ffmpeg  -accurate_seek -i acts/PaulinEphesus.mp4 -ss 0  -vf scale=480:-1    video/multiply3/338.mp4
...
ffmpeg  -accurate_seek -i acts/ThroughMacedoniaandGreece.mp4 -ss 0  -vf scale=480:-1    concat/341.mp4
...
ffmpeg  -accurate_seek -i acts/OntoJerusalem.mp4 -ss 0  -vf scale=480:-1    concat/343.mp4
...
ffmpeg  -accurate_seek -i acts/PaultheRomanCitizen.mp4 -ss 0  -vf scale=480:-1    concat/346.mp4
...
ffmpeg  -accurate_seek -i acts/Paul39sTrialBeforeFestus.mp4 -ss 0  -vf scale=480:-1    concat/349.mp4
...
ffmpeg  -accurate_seek -i acts/PaulSailsforRome.mp4 -ss 0  -vf scale=480:-1    concat/351.mp4
...
ffmpeg  -accurate_seek -i acts/PaulFinallyReachesRome.mp4 -ss 0  -vf scale=480:-1    concat/354.mp4
