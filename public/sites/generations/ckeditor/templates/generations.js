CKEDITOR.addTemplates('default', {
  imagesPath: CKEDITOR.getUrl('/sites/generations/ckeditor/templates/images/'),
  templates: [
    {
      title: 'Note Area',
      image: 'notes.png',
    ...
    {
      title: 'Reveal Big Plus',
      image: 'reveal_big.png',
      description:
        'Students can reveal content by pressing on area. Best used for summaries',
      html: '\x3cdiv class\x3d"reveal_big"\x3e&nbsp;\x3chr\x3e Put summary or other text to reveal here \x3chr\x3e\x3c/div\x3e',
    },
    {
      title: 'Reveal Small Plus',
      image: 'reveal_small.png',
      description:
        'Students can reveal content by pressing on area. Best used for truth sets.',
      html: '\x3cdiv class\x3d"reveal"\x3e&nbsp;\x3chr\x3e Text to reveal here \x3chr\x3e\x3c/div\x3e',
    },
    {
      title: 'Bible Passage',
      image: 'bible.png',
